 ...
 *           example: Antonia Jocerlania
 *         email:
 *           type: string
 *           description: E-mail do usuário.
 *           example: antonia@gmail.com
 *         password:
 *           type: string
 ...
 *     description: Recupera a lista de contatos da agenda. Pode ser utilizado sem autenticação.
 *     responses:
 *       200:
 ...
 *     description: Recupera um único contato da agenda pelo ID. Pode ser utilizado sem autenticação.
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
